<template>
  <div class="aero_solo" data-name="aerogen_solo">
    <header>
      <h1>Aerogen Solo</h1>
      <div class="solo_pic">
        <img src="http://img.youyao99.com/BD58860E6A77A8700B4D87D482DBFD55.png" />
      </div>
    </header>
    ...
    <div class="aerogen_ad prod_ad">
      ...
      <div class="prod_ad_pic">
        <img src="http://img.youyao99.com/491700C0422D2DF3A18519B940DBB05E.png" />
      </div>
    </div>
    <div class="aerogen_ad setting_ad">
      ...
      <ul>
          ...
          <div class="setting_pic">
            <img src="http://img.youyao99.com/5330A478E20042F16CBF1A8B05CD792F.png" />
          </div>
        </li>
        <li>
          <h5>通气支持时在三通内的沉积 </h5>
          <div class="setting_pic">
            <img src="http://img.youyao99.com/6E6BDEA119F4F6E95C61CF24ABB43A81.png" />
          </div>
        </li>
        <li>
          <h5>儿科高流量</h5>
          <div class="setting_pic">
            <img src="http://img.youyao99.com/22F1AB722ABCEEEACA96D78D593CCEC7.png" />
          </div>
        </li>
      </ul>
    </div>
        ...
        advantage_list:[
          {
            id:1,
            title:'适用性',
            content:'通气或是非通气患者所需的设备都可以使用气溶胶给药方法'
          },
          {
            id:2,
            title:'使用简便',
          ...
          },
          {
            id:7,
            title:'多样性',
            content:'适用于溶液、悬浊液、蛋白和肽'
          },
          {
            id:8,
            title:'经济',
            content:'每个病人阶段性使用28天或是持续使用7天'
          },
        ]
      }
    },
