    ...
    <div class="fs_flow_hos_rp">
        ...
        <div class="area_rp_list">
            ...
            <template v-if="area_flow_list.length != 0">
              <HosList :lowHosList='area_flow_list'></HosList>
            </template>
...
import { hosFlowData } from '../../api/sendRequest.js'
export default{
    data(){
      return {
        date:'',
    ...
    methods:{
      async getFlowData(){
        let res = await hosFlowData(getStore('openid'),this.$route.query.area);
