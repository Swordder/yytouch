    ...
    <div class="fs_agent_rp">
        ...
        <div class="area_rp_list">
          <template v-if="rep_hospital.length != 0">
            <HosList :lowHosList='rep_hospital'></HosList>
          </template>
...
import { repData } from '../../api/sendRequest.js'
...
export default{
    ...
    methods:{
      async getAgentData(){
        let res = await repData(getStore('openid'),this.$route.query.u_yyid);
